...
var import_html_blocks = __toESM(require("markdown-it/lib/common/html_blocks"));
var vueReservedTags = [
  "template",
  "component",
  "transition",
...
var HTML_SEQUENCES = [
  ...
  [
    new RegExp(`^</?(${import_html_blocks.default.join("|")})(?=(\\s|/?>|$))`, "i"),
    /^$/,
    true
  ],
  [
...
function resolveOptions(userOptions) {
  ...
  const options = userOptions.frontmatterPreprocess ? __spreadValues(__spreadValues({}, defaultOptions), userOptions) : __spreadProps(__spreadValues(__spreadValues({}, defaultOptions), userOptions), {
